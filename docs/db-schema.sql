-- =============================================================================
-- Seismo 0.4 — Database schema (consolidated, for review)
-- =============================================================================
--
-- Source of truth: `initDatabase()` in config.php (SCHEMA_VERSION = 17). That
-- function creates tables with IF NOT EXISTS and then applies incremental
-- ALTERs for existing installs. This file is the fully-migrated end state,
-- flattened for review. It is NOT executed by the app; do not edit the app
-- to read from it.
--
