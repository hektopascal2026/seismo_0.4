    ...
    <div class="container">
        <div class="top-bar">
            ...
            <div class="top-bar-actions">
                <a href="?action=refresh_all_substacks<?= $selectedSubstackCategory ? '&category=' . urlencode($selectedSubstackCategory) : '' ?>" class="top-bar-btn" title="Refresh Substack feeds"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2v6h-6"/><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M3 22v-6h6"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/></svg></a>
