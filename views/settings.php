...
<body>
    <div class="container">
        ...
        <?php if ($settingsTab === 'styleguide'): ?>
        <style>
            .styleguide-section { margin-bottom: 60px; padding-bottom: 40px; border-bottom: 2px solid #000000; }
            .styleguide-section:last-child { border-bottom: none; }
            .styleguide-section h2 { font-size: 18px; font-weight: 700; margin-bottom: 30px; }
            .styleguide-section h3 { font-size: 18px; font-weight: 700; margin-top: 30px; margin-bottom: 15px; }
            .styleguide-section p { font-size: 12px; color: #000000; }
            .color-swatch { display: inline-block; width: 120px; height: 120px; border: 2px solid #000000; margin-right: 20px; margin-bottom: 20px; vertical-align: top; position: relative; }
            .color-swatch-info { position: absolute; bottom: 0; left: 0; right: 0; background-color: rgba(255,255,255,0.95); padding: 8px; font-size: 12px; font-weight: 600; border-top: 2px solid #000000; }
            .logo-showcase { display: flex; gap: 40px; align-items: center; margin: 30px 0; flex-wrap: wrap; }
            .logo-variant { display: flex; flex-direction: column; align-items: center; gap: 15px; }
            .logo-variant-label { font-size: 12px; font-weight: 600; color: #000000; text-transform: uppercase; letter-spacing: 0.5px; }
            .component-demo { border: 1px solid #000000; padding: 20px; margin: 20px 0; background-color: #ffffff; }
            .code-block { background-color: #f5f5f5; border: 1px solid #000000; padding: 15px; margin: 15px 0; font-family: 'Courier New', monospace; font-size: 12px; overflow-x: auto; }
            .typography-sample { margin: 20px 0; padding: 15px; border-left: 4px solid #000000; background-color: #fafafa; }
        </style>
        <p style="font-size: 12px; margin-bottom: 16px;">Design system documentation for Seismo.</p>
        ...
        <section class="styleguide-section">
            ...
            <h3>Core</h3>
            <div>
                <div class="color-swatch" style="background-color: #000000;"><div class="color-swatch-info">#000000<br>Black</div></div>
                <div class="color-swatch" style="background-color: #FFFFFF;"><div class="color-swatch-info">#FFFFFF<br>White</div></div>
                <div class="color-swatch" style="background-color: #FF6B6B;"><div class="color-swatch-info">#FF6B6B<br>Coral Accent</div></div>
                <div class="color-swatch" style="background-color: #FFFFC5;"><div class="color-swatch-info">#FFFFC5<br>Yellow</div></div>
                <div class="color-swatch" style="background-color: #F5F5F5;"><div class="color-swatch-info">#F5F5F5<br>Light Gray</div></div>
            </div>
            <h3>Semantic (button borders)</h3>
            <div>
                <div class="color-swatch" style="background-color: #FF2C2C;"><div class="color-swatch-info">#FF2C2C<br>Danger</div></div>
                <div class="color-swatch" style="background-color: #ff9900;"><div class="color-swatch-info">#ff9900<br>Warning</div></div>
                <div class="color-swatch" style="background-color: #00aa00;"><div class="color-swatch-info">#00aa00<br>Success</div></div>
            </div>
            <h3>Tag Colors</h3>
            <div>
                <div class="color-swatch" style="background-color: #add8e6;"><div class="color-swatch-info">#add8e6<br>RSS Tags</div></div>
                <div class="color-swatch" style="background-color: #FFDBBB;"><div class="color-swatch-info">#FFDBBB<br>Email Tags</div></div>
                <div class="color-swatch" style="background-color: #C5B4D1;"><div class="color-swatch-info">#C5B4D1<br>Substack Tags</div></div>
                <div class="color-swatch" style="background-color: #f5f562;"><div class="color-swatch-info">#f5f562<br>Lex Tags</div></div>
            </div>
        </section>
        ...
        <section class="styleguide-section">
            ...
            <div class="component-demo">
                <div class="entry-card">
                    ...
                    <h3 class="entry-title"><a href="#">Entry Title Example</a></h3>
        ...
        <section class="styleguide-section">
            ...
            <div class="component-demo">
                <div class="tag-filter-list">
                    <label class="tag-filter-pill" style="background-color: #add8e6;"><input type="checkbox" checked><span>RSS Tag</span></label>
                    <label class="tag-filter-pill"><input type="checkbox"><span>RSS Inactive</span></label>
                    <label class="tag-filter-pill" style="background-color: #FFDBBB;"><input type="checkbox" checked><span>Email Tag</span></label>
                    <label class="tag-filter-pill" style="background-color: #C5B4D1;"><input type="checkbox" checked><span>Substack Tag</span></label>
                    <label class="tag-filter-pill" style="background-color: #f5f562;"><input type="checkbox" checked><span>Lex Tag</span></label>
                    <label class="tag-filter-pill"><input type="checkbox"><span>Inactive</span></label>
                </div>
            </div>
